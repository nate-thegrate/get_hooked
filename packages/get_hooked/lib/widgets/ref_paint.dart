...
extension type PaintingRef._(_RefPainterElement _element) implements PainterRef {
  ...
  /// Selects a value based on 2 inputs, and triggers a re-render when it changes.
  ///
  /// At least one of the inputs must be a [Listenable] or [Get] object.
  Result select2<Result, L1, L2>(
    L1 l1,
    L2 l2,
    ...
    return _select(ProxyListenable(l1, l2), () => selector(l1, l2));
  }

  /// Selects a value based on 3 inputs, and triggers a re-render when it changes.
  ///
  /// At least one of the inputs must be a [Listenable] or [Get] object.
  Result select3<Result, L1, L2, L3>(
    L1 l1,
    L2 l2,
    L3 l3,
    ...
    return _select(ProxyListenable(l1, l2), () => selector(l1, l2, l3));
  }

  /// Selects a value based on 4 inputs, and triggers a re-render when it changes.
  ///
  /// At least one of the inputs must be a [Listenable] or [Get] object.
  Result select4<Result, L1, L2, L3, L4>(
    L1 l1,
    L2 l2,
    L3 l3,
    L4 l4,
    ...
    return _select(ProxyListenable(l1, l2, l3, l4), () => selector(l1, l2, l3, l4));
  }

  /// Selects a value based on 5 inputs, and triggers a re-render when it changes.
  ///
  /// At least one of the inputs must be a [Listenable] or [Get] object.
  Result select5<Result, L1, L2, L3, L4, L5>(
    L1 l1,
    L2 l2,
    L3 l3,
    L4 l4,
    ...
    return _select(ProxyListenable(l1, l2, l3, l4, l5), () => selector(l1, l2, l3, l4, l5));
  }

  /// Selects a value based on 6 inputs, and triggers a re-render when it changes.
  ///
  /// At least one of the inputs must be a [Listenable] or [Get] object.
  Result select6<Result, L1, L2, L3, L4, L5, L6>(
    L1 l1,
    L2 l2,
    L3 l3,
    L4 l4,
  ...
  /// Selects a value based on 7 inputs, and triggers a re-render when it changes.
  ///
  /// At least one of the inputs must be a [Listenable] or [Get] object.
  Result select7<Result, L1, L2, L3, L4, L5, L6, L7>(
    L1 l1,
    L2 l2,
    L3 l3,
    L4 l4,
  ...
  /// Selects a value based on 8 inputs, and triggers a re-render when it changes.
  ///
  /// At least one of the inputs must be a [Listenable] or [Get] object.
  Result select8<Result, L1, L2, L3, L4, L5, L6, L7, L8>(
    L1 l1,
    L2 l2,
    L3 l3,
    L4 l4,
  ...
  /// Selects a value based on 9 inputs, and triggers a re-render when it changes.
  ///
  /// At least one of the inputs must be a [Listenable] or [Get] object.
  Result select9<Result, L1, L2, L3, L4, L5, L6, L7, L8, L9>(
    L1 l1,
    L2 l2,
    L3 l3,
    L4 l4,
