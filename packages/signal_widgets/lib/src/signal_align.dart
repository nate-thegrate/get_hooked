...
/// A variant of [Align] that evaluates based on a [SignalComputer<AlignmentGeometry>].
class SignalAlign extends SingleChildRenderObjectWidget {
  /// Creates an [Align] widget using the provided [SignalComputer] callback.
  const SignalAlign(this.alignment, {super.key, super.child});
  ...
  final SignalComputer<AlignmentGeometry> alignment;

  @override
  RenderSignalAlign createRenderObject(BuildContext context) => RenderSignalAlign();

  @override
  SingleChildRenderObjectElement createElement() => _AlignElement(this);
}

class _AlignElement extends SingleChildSignalElement<RenderSignalAlign> {
  ...
  @override
  void recompute() {
    alignment = (widget as SignalAlign).alignment(this);
  }
}
...
/// dimensions.
class RenderSignalAlign extends RenderShiftedBox {
  /// Creates a render object that positions its child.
  RenderSignalAlign() : super(null);
  ...
  Size computeDryLayout(covariant BoxConstraints constraints) {
    final Size childSize = child?.getDryLayout(constraints.loosen()) ?? Size.zero;
    return constraints.constrain(
      Size(
        constraints.maxWidth == double.infinity ? childSize.width : double.infinity,
        constraints.maxHeight == double.infinity ? childSize.height : double.infinity,
      ),
    );
  }
